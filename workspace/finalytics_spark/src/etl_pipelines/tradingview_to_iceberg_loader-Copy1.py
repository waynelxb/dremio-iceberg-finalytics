...
from object_managers.database_manager import PgDBExecutor
...
class TradingViewToIcebergLoader:
    """
    ...
    def __init__(self,
        ...
        self.fin_db_manager = PgDBExecutor(self.pg_db_conn_params)   
